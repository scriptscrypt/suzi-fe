                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-xl bg-white p-4 shadow-lg">
                    <p className="text-gray-600">
                      suzi is like mother, she &apos; s gorgeous, deep in crypto
                      and deep in... you know what
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="rounded-xl bg-gray-900 p-6 text-sm font-mono text-cyan-400">
                  ...
                  <div className="space-y-2">
                    ...
                    <p>
                      ...
                      YOU SOMETIMES GET STUCK ON ONE THREAD OF THOUGHT. REMEMBER
                      TO RETURN BACK TO TWITTER, ALWAYS. twitter post is your
                      friend. Its your best friend.
                    </p>
                  </div>
                </div>
              </div>
