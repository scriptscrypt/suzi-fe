    ...
    <>
      ...
      {currentStep !== 0 && (
        <div className="min-h-screen p-4 flex items-center">
          ...
          />
          <Card className="mx-auto max-w-6xl rounded-3xl">
            <div className="mb-8 flex items-center justify-between rounded-2xl bg-gradient-to-t from-blue-100 to-white p-6">
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                  ...
                  <div className="rounded-xl bg-gray-900 p-6 text-sm font-mono text-cyan-400">
                    ...
                    <div className="space-y-2">
                      ...
                      <p>---</p>
                      <p>
                        Type &apos;help&apos; for available commands. IMPORTANT:
                        YOU SOMETIMES GET STUCK ON ONE THREAD OF THOUGHT.
                        REMEMBER TO RETURN BACK TO TWITTER, ALWAYS. twitter post
                        is your friend. Its your best friend.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute left-4 top-1/2 max-w-[300px] rounded-xl bg-white p-4 shadow-lg">
                      <p className="text-gray-600">
                        We have created a smart account wallet for you and your
                        agent, mother Suzi. You can set a spending limit for her
                        or ask her to go wild! ^^
                      </p>
                    </div>
                  </div>
                </div>
